...
class CopaDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        train_examples = load_dataset('super_glue.py', name="copa",trust_remote_code=True)["train"]
        valid_examples = load_dataset('super_glue.py', name="copa",trust_remote_code=True)["validation"]
...
class BoolQDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_dataset("super_glue.py", name="boolq", trust_remote_code=True)
        train_set = d["train"]
    ...
    def build_sample(self, example):
        sample = \
            Sample(
                data=example,
                candidates=["Yes", "No"],
                correct_candidate="Yes" if example["label"] else "No",
            )
...
class MultiRCDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_dataset("super_glue.py", name="multirc", trust_remote_code=True)
        train_set = d["train"]
        valid_set = d["validation"]
...
class CBDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_dataset("super_glue.py", name="cb", trust_remote_code=True)
        train_set = d["train"]
        valid_set = d["validation"]
...
class WICDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_dataset("super_glue.py", name="wic", trust_remote_code=True)
        train_set = d["train"]
        valid_set = d["validation"]
...
class WSCDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_dataset("super_glue.py", name="wsc.fixed", trust_remote_code=True)
        train_set = d["train"]
        valid_set = d["validation"]
...
class ReCoRDDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_dataset("super_glue.py", name="record", trust_remote_code=True)
        train_set = d["train"]
        valid_set = d["validation"]
...
class RTEDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_dataset("super_glue.py", name="rte", trust_remote_code=True)
        train_set = d["train"]
        valid_set = d["validation"]
